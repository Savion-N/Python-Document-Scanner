...
from imp.transform import four_point_transform
...
if(x=='Y' or x=='y'):
    print("\n Starting to recognize text from the image... ")
    text = get_string(img_path)
    print(text)
    print("\n Writing the recognized text into the file... \n\n")
    with open("./scanned_output/OCR Text.txt", "w", encoding="utf-8") as f:
        f.write(text)
        f.close()
        
    #change the path of the OCR Text.txt file to open it.
    os.startfile('C:/Users/sony/OneDrive/Documents/Coding_Projects/Document Scanner/scanned_output/OCR Text.txt')
    print(" Done! ")
